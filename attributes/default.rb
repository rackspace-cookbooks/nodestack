...
if node['demo']
  ...
  default['nodestack']['apps']['my_nodejs_app']['app_options'] = []
  ...
  default['nodestack']['apps']['my_nodejs_app']['enable_submodules'] = false
  ...
  default['nodestack']['apps']['my_nodejs_app']['deployment']['before_symlink'] = nil
